...
public class CodeGen {
    ...
    public static void main(String[] args) throws Exception {
        ...
        properties.load(CodeGen.class.getClassLoader().getResourceAsStream("mybatis-plus-generator-user.properties"));
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + properties.getProperty("interfaceOutputDir")
                        + "/cn/yinsh/hrm/domain/" + tableInfo.getEntityName() + StringPool.DOT_JAVA;
            }
        });
        //query自定义生成路径
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                return projectPath + properties.getProperty("interfaceOutputDir")
                        + "/cn/yinsh/hrm/query/" + tableInfo.getEntityName() + "Query" + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + properties.getProperty("mapperOutputDir") + "/cn/yinsh/hrm/mapper/"
        ...
        strategy.setInclude("t_sso","t_vip_address","t_vip_base","t_vip_course_collect","t_vip_course_view","t_vip_grow_log","t_vip_login_log","t_vip_msg","t_vip_realinfo");
